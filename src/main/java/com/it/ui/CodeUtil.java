...
import com.it.core.GeneratorFacade;
...
public class CodeUtil extends JFrame {
     ...
     */
    CodeUtil(DataBase db, String dbName) {
        this.db = db;
        this.dbName = dbName;
        initComponents();
    }
...
//												.addComponent(jTextField4)
        ...
        final Thread t = new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    //获取当前文件夹下的模板目录下的所有文件夹							\\windows: "\\模板\\" iOS :/模板/"
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {
        this.jTextField5.setText(selectPath());
    }
...
//	}
    ...
    private String selectPath() {
        ...
        jfc.showDialog(new JLabel(), "选择代码生成路径");
