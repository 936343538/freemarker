...
public class ${className}Esb extends BaseEsb {
    ...
    interface Methods {
        String ${table.name!}_LIST_GET = "${className?uncap_first}.list.get";
        String ${table.name!}_GET = "${className?uncap_first}.get";
        String ${table.name!}_DELETE = "${className?uncap_first}.delete";
        String ${table.name!}_ADD = "${className?uncap_first}.add";
        String ${table.name!}_UPDATE = "${className?uncap_first}.update";
    }

    @Autowired
    private ${className}Service ${className?uncap_first}Service;

    @ServiceMethod(method = Methods.${table.name!}_LIST_GET)
